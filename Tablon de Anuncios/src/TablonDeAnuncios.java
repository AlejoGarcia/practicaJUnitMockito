...
public class TablonDeAnuncios {
  ...
  public void publicarAnuncio(Anuncio anuncio, 
    ...
    if (anuncio.anunciante_.equals("LA EMPRESA")&&(buscarAnuncioPorTitulo(anuncio.titulo_)==null))
      listaDeAnuncios_.add(anuncio);
    else {
      if (!(anuncio.anunciante_.equals("LA EMPRESA") || bdAnunciantes.buscarAnunciante(anuncio.anunciante_))) throw new AnuncianteNoExisteException();
      if ( 	(buscarAnuncioPorTitulo(anuncio.titulo_)==null) &&
              (bdAnunciantes.buscarAnunciante(anuncio.anunciante_)) &&
